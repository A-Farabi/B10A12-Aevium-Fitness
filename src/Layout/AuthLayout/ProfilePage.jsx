...
const ProfilePage = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      setUpdated(true);
      setTimeout(() => setUpdated(false), 3000); // Hide success after 3s
    } catch (err) {
  ...
  return (
    <div className="max-w-lg mx-auto bg-base-100 shadow-xl rounded-2xl overflow-hidden transition-all duration-300">
      {/* Header Banner */}
      <div
        className="h-24"
        style={{
